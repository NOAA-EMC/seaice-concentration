...
sland_mask = ma.logical_or(sland_mask, ma.masked_array(delta(t19v, t19h) < 0.018077900915434868) )
#land mask, ~60k pts
sland_mask = ma.logical_or(sland_mask, ma.masked_array(delta(t19h, t37v) > 0.05150437355041504) )
sland_mask = ma.logical_or(sland_mask, ma.masked_array(t37v > 261) )

#imperfect land mask (3% ice), 60 k pts
